...
This is the first release of ReSCUEApp, providing a user-friendly interface to seabird flight height distributions developed through the Reducing Seabird Collisions Using Evidence (ReSCUE) project.
...
- **FHD Analysis Tools:** The Data Analysis tab offers tools for the analysis and comparison of FHD data, including height-shifted mitigation scenarios 
...
- **Grant Humphries** (Author, BlackHawks)
- **Carl Donovan** (Contributor, DMP Statistics)
